...
class ShipmentService extends BaseService {
  ...
  async assignVehicle(shipmentId: string, vehicleId: string, driverId: string): Promise<Shipment>
  async startTransit(shipmentId: string): Promise<Shipment> // → IN_TRANSIT
  async completeStop(shipmentId: string, stopId: string, proof: ProofInput): Promise<ShipmentStop>
...
class VehicleService extends BaseService {
  ...
  async returnFromMaintenance(id: string, inspectionId?: string): Promise<Vehicle>
...
class DriverService extends BaseService {
  ...
  async recordViolation(driverId: string, input: RecordViolationInput): Promise<DriverViolation>
  async recordIncident(driverId: string, input: RecordIncidentInput): Promise<DriverIncident>
  async suspendDriver(driverId: string, reason: string, days: number): Promise<Driver>
